...
\newpage
\appendix
\section*{Appendix A: Repository and Code Access}

All source code, scripts, and datasets used in this project are available at the following public repository:

\begin{center}
\textbf{GitHub Repository:}  
\url{https://github.com/ThobiasKH/ELE201-semesterproject}
\end{center}

The contents of the repository include, but are not limited to:
\begin{itemize}
    \item STM32 firmware source code.
    \item Python scripts for serial communication and data analysis.
    \item Statistical test suite and Monte Carlo demonstration code.
\end{itemize}
